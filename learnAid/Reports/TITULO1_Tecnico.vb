...
Public Class TITULO1_Tecnico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.TITULO1_Tecnico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTITULO1_Tecnico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TITULO1_Tecnico = New TITULO1_Tecnico()
        rpt.Site = Me.Site
        Return rpt
    End Function
