...
Public Class TITULO1_Programa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.TITULO1_Programa.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SCH_ID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTITULO1_Programa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TITULO1_Programa = New TITULO1_Programa()
        rpt.Site = Me.Site
        Return rpt
    End Function
