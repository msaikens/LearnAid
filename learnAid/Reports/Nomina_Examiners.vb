...
Public Class Nomina_Examiners
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.Nomina_Examiners.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNomina_Examiners
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Nomina_Examiners = New Nomina_Examiners()
        rpt.Site = Me.Site
        Return rpt
    End Function
