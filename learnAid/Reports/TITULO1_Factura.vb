...
Public Class TITULO1_Factura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.TITULO1_Factura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTITULO1_Factura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TITULO1_Factura = New TITULO1_Factura()
        rpt.Site = Me.Site
        Return rpt
    End Function
