...
Public Class INDIVIDUAL_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.INDIVIDUAL_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CurrGrade() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedINDIVIDUAL_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INDIVIDUAL_1 = New INDIVIDUAL_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
