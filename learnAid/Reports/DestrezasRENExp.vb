...
Public Class DestrezasRENExp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.DestrezasRENExp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDestrezasRENExp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DestrezasRENExp = New DestrezasRENExp()
        rpt.Site = Me.Site
        Return rpt
    End Function
