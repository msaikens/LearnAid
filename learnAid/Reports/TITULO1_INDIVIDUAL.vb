...
Public Class TITULO1_INDIVIDUAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.TITULO1_INDIVIDUAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTITULO1_INDIVIDUAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TITULO1_INDIVIDUAL = New TITULO1_INDIVIDUAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
