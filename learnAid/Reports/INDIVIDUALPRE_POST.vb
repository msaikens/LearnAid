...
Public Class INDIVIDUALPRE_POST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.INDIVIDUALPRE_POST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINDIVIDUALPRE_POST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INDIVIDUALPRE_POST = New INDIVIDUALPRE_POST()
        rpt.Site = Me.Site
        Return rpt
    End Function
