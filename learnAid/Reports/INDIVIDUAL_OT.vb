...
Public Class INDIVIDUAL_OT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.INDIVIDUAL_OT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINDIVIDUAL_OT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INDIVIDUAL_OT = New INDIVIDUAL_OT()
        rpt.Site = Me.Site
        Return rpt
    End Function
