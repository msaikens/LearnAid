...
Public Class FiveYearsData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.FiveYearsData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFiveYearsData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FiveYearsData = New FiveYearsData()
        rpt.Site = Me.Site
        Return rpt
    End Function
