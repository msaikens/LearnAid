...
Public Class T1_DestrezasColegio
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "T1_DestrezasColegio.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "learnAid.T1_DestrezasColegio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT1_DestrezasColegio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T1_DestrezasColegio = New T1_DestrezasColegio()
        rpt.Site = Me.Site
        Return rpt
    End Function
